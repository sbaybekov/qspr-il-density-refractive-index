...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Apply the consensus model to predict density of IL in isopropanol.")
    ...
    parser.add_argument("--model_dir", help="Directory containing the ensemble of models and metadata (default: density_isopropanol_ensemble_model).")
